...
function RecoverAccount({ setWallet, setSeedPhrase }) {
  ...
  return (
    <>
      <div className="content">
        ...
        <Button disabled={ typedSeed.split(" ").length !== 12 || typedSeed.slice(-1) === " "} className="frontPageButton" type="primary" onClick={() => recoverWallet()}>
          Recover Wallet
        </Button>
  ...
  //grape divide fly exhibit blush rule suffer yard wheel symbol knock share
}
